return function(c, s, cs)
    ...
    return {
        ...
        { constructors, c.dark_white, c.none }, -- in C++ variable->constructors() \\ TS docs unclear
        { conditionals, c.intense_blue, c.none },
        { constants, c.dark_white },
        { defines, c.intense_blue },
        { exceptions, c.blue },
        { fields, c.yellow },
        { functions, c.bright_cyan, c.none },
        ...
        { nones, c.dark_white },
        { operators, c.blue },
        { parameters, c.dark_white, c.none },
        { properties, c.yellow },
        { punctuations, c.blue },
        { repeats, c.blue, c.none },
        { strings, c.green },
